...
| 05-graphql | [08-05-PLAN.md](08-05-PLAN.md) | 3 | 01 | GraphQL introspection + schema explorer — **DEFERRED**, not executed |
...
- 05-graphql deferred (not executed): GraphQL introspection/schema explorer
  moves to Future. Plan file kept for later.
- Post-phase additions (2026-08-09, beyond roadmap): {{$dynamic}} values in
  interpolate; save-history-entry-to-collection in the sidebar.
